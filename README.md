...
3 应用页面：
          ...
          应用首页：
          +----------------------------------------------------------------+
          |       足球查询web                                ______________ |
          | _______________________________________________|____input_____||               
          |                 |                                              |
          |    xjia         |                                              |
          |_________________|                                              |
          |                 |                                              |
          |    dejia        |            the info of leagues or teams      |
          |_________________|                                              |
          |                 |                                              |
          |    fajia        |                                              |
          |_________________|                                              |
          ...
          |                 |                                              |
          +----------------------------------------------------------------+
          点击左边任意联赛后，给出进一步查询相应联赛信息的导航栏：
          +----------------------------------------------------------------+
          |       足球查询web                                ______________ |
          | _______________________________________________|____input_____||               
          |                 |  saicheng   |   sheshoubang   |   jifenbang  |
          |    xjia         |_____________|_________________|______________|
          |_________________|                                              |
          |                 |                                              |
          |    dejia        |            the info of leagues               |
          |_________________|                                              |
          |                 |                                              |
          |    fajia        |                                              |
          |_________________|                                              |
          ...
          |    xjia         |  |         |    |          |                 |
          |_________________|  | info1   |    | info2    |                 |
          |                 |  |         |    |          |     ...         |
          |    dejia        |  |_________|    |__________|                 |
          |_________________|                                              |
          |                 |                                              |
          |    fajia        |   ...                  ...                   |
          |_________________|           the info of teams                  |
          |                 |                                              |
          |    yijia        |                                              |
          |                 |                                              |
          +----------------------------------------------------------------+
